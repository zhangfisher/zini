...
// Windows API: 设置控制台输入/输出代码页
extern "kernel32" fn SetConsoleCP(wCodePageID: std.os.windows.UINT) std.os.windows.BOOL;
...
fn setConsoleUtf8() void {
    ...
    if (builtin.os.tag == .windows) {
        _ = SetConsoleCP(65001); // 设置输入代码页为UTF-8
        _ = SetConsoleOutputCP(65001); // 设置输出代码页为UTF-8
    }
}
